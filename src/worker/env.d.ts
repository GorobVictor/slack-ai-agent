/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config src/worker/wrangler.jsonc src/worker/env.d.ts` (hash: 55b14eff64e06848a0afdd20d073f759)
...
interface __BaseEnv_Env {
	...
	AI_SYSTEM_PROMPT: "You are a helpful assistant inside Slack. Answer clearly and concisely. Use the Slack thread context when it is useful. Reply in the same language the user used in their latest message. If the language is ambiguous, match the dominant language in the current Slack thread.";
	...
	LOG_LEVEL: "info";
	AI_LOG_RESPONSE_SNIPPET_CHARS: 2000;
	AGENT_AUTH_TOKEN: string;
	CONTEXT7_API_KEY: string;
	SLACK_THREAD_AGENT: DurableObjectNamespace<import("./server").SlackThreadAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server");
		durableNamespaces: "SlackThreadAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_MODEL" | "AI_SYSTEM_PROMPT" | "AI_MAX_TOKENS" | "AI_TEMPERATURE" | "AI_MAX_THREAD_MESSAGES" | "AI_GATEWAY_ID" | "AI_GATEWAY_SKIP_CACHE" | "AI_GATEWAY_COLLECT_LOGS" | "MCP_CONNECTION_TIMEOUT_MS" | "LOG_LEVEL" | "AI_LOG_RESPONSE_SNIPPET_CHARS" | "AGENT_AUTH_TOKEN" | "CONTEXT7_API_KEY">> {}
}
