/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config src/worker/wrangler.jsonc src/worker/env.d.ts` (hash: a720b937c2d832ac538ca8f2cd460ad9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_MODEL" | "AI_SYSTEM_PROMPT" | "AI_MAX_TOKENS" | "AI_TEMPERATURE" | "AI_MAX_THREAD_MESSAGES" | "AGENT_AUTH_TOKEN">> {}
}
