/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config src/worker/wrangler.jsonc src/worker/env.d.ts` (hash: 64262de6709a9ba6df83b3ec9c2fbf16)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_MODEL" | "AI_SYSTEM_PROMPT" | "AI_MAX_TOKENS" | "AI_TEMPERATURE" | "AI_MAX_THREAD_MESSAGES" | "AI_GATEWAY_ID" | "AI_GATEWAY_SKIP_CACHE" | "AI_GATEWAY_COLLECT_LOGS" | "AGENT_AUTH_TOKEN">> {}
}
