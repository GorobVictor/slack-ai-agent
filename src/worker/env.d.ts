/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config src/worker/wrangler.jsonc src/worker/env.d.ts` (hash: 9b7148b7fce89437df64f5be00d77779)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_MODEL" | "AGENT_AUTH_TOKEN">> {}
}
