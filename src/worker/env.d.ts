/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config src/worker/wrangler.jsonc src/worker/env.d.ts` (hash: febf8209e9711b6db1464dc50d40de9e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_MODEL" | "AI_SYSTEM_PROMPT" | "AI_MAX_TOKENS" | "AI_TEMPERATURE" | "AI_MAX_THREAD_MESSAGES" | "AI_GATEWAY_ID" | "AI_GATEWAY_SKIP_CACHE" | "AI_GATEWAY_COLLECT_LOGS" | "MCP_CONNECTION_TIMEOUT_MS" | "AGENT_AUTH_TOKEN">> {}
}
