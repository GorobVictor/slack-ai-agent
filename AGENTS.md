...
- `src/worker/wrangler.jsonc` also configures the Workers AI model, system prompt, generation settings, thread history limit, and AI Gateway routing through `vars`.
